...
oct_feedback <- oct_feedback %>% rename(
 ...
 hp_knowledge_increased = "1.\tPlease indicate how much do you agree or disagree with each of the following statements according to this scale. [I know more about health promotion as a result of attending this forum]"                           ,           
  ...
  cchp_awareness_increased =  "1.\tPlease indicate how much do you agree or disagree with each of the following statements according to this scale. [I know more about the Collaborating Centres for Health Promotion as a result of attending this forum]",      
  APACPH_awareness_increased = "1.\tPlease indicate how much do you agree or disagree with each of the following statements according to this scale. [I know more about the Asia-Pacific Academic Consortium for Public Health as a result of attending this forum]",
...
organization_type =  "4.3 What type of organization do you work for (e.g university, government, hospital, etc)"     ,                                                                                                                                    
 ...
 come_ifnot_required = "4.8 If you answered yes to questions 4.6 or 4.7, would you have chosen to attend this event if you weren’t required to attend?" ,
